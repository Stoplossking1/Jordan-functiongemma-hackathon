...
// mathjs module declaration for Deno compatibility
declare module 'mathjs' {
  export interface EvalFunction {
    evaluate(scope?: Record<string, unknown>): number;
  }
  ...
  export interface MathJsInstance {
    ...
    simplify(expr: string | MathNode, rules?: unknown[]): MathNode;
    fraction(value: number): Fraction;
    lusolve(A: number[][], b: number[]): number[][];
  }

  export function create(factories: unknown): MathJsInstance;
