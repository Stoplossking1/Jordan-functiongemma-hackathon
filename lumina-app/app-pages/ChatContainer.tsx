...
export default function ChatContainer(props: ChatProps): ReactNode {
  ...
  const { styles, headerStyles, searchInputStyles, retryButtonStyles, newChatButtonStyles, conversationItemStyles, emptyStateStyles } =
    useChatStyles();
        ...
        <View style={styles.contentContainer}>
          <View style={styles.searchContainer}>
            <View style={styles.searchRow}>
              ...
              <CustomButton title="+ New" onPress={onNewChat} styles={newChatButtonStyles} />
            </View>
          </View>
