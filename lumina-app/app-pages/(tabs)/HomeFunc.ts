...
export interface HomeFunc {
  ...
  /**
   * Handler for voice recording button press - navigates to assistant with voice mode
   */
  onRecordVoice: () => void;

  /**
   * Handler for type problem button press - navigates to assistant directly
   */
  onTypeProblem: () => void;
